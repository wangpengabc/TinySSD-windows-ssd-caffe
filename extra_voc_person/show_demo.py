...
def convert_annotation(year, image_id):
    im_path = ('/home/sdc/wangpeng/data/VOCdevkit/VOC%s/JPEGImages/%s.jpg' % (year, image_id))
    ...
    #
    # label_path = ('/home/sdc/wangpeng/data/VOCdevkit/VOC%s/labels/%s.txt' % (year, image_id))
    #
...
if __name__ == '__main__':
    convert_annotation('2012', '2011_003152')
