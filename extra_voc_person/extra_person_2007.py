...
VOC_ROOT = '/home/sdc/wangpeng/data/'

# person类训练集、测试集标签地址
VOC2007_trainval = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2007/ImageSets/Main/person_trainval.txt')
VOC2007_test = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2007/ImageSets/Main/person_test.txt')
# 标签所在文件夹
VOC2007_label = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2007/ImageSets/person_Main/')

# 图片和标注地址
VOC2007_images = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2007/JPEGImages')
VOC2007_annotations = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2007/Annotations')
