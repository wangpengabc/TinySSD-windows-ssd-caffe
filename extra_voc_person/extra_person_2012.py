...
# person类训练集、测试集标签地址
VOC2012_trainval = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2012/ImageSets/Main/person_trainval.txt')
# VOC2012_test =      'VOCdevkit/VOC2012/ImageSets/Main/person_test.txt'
# 标签所在文件夹
VOC2012_label = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2012/ImageSets/person_Main/')

# 图片和标注地址
VOC2012_images = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2012/JPEGImages')
VOC2012_annotations = os.path.join(VOC_ROOT, 'VOCdevkit/VOC2012/Annotations')
